...
class Post(models.Model):
    ...
    image = models.ImageField(upload_to='posts/%Y/%m/%d/', blank=True, null=True, verbose_name='图片')  # 帖子图片，按日期存储
...
class Comment(models.Model):
    ...
    likes = models.ManyToManyField(User, related_name='liked_comments', blank=True, verbose_name='点赞')  # 新增点赞字段
...
class UserProfile(models.Model):
    ...
    bookmarks = models.ManyToManyField('Post', related_name='bookmarked_by', blank=True, verbose_name='收藏')
    friends = models.ManyToManyField(User, related_name='friend_profiles', blank=True, verbose_name='好友')
